...
class Model
{
    ...
    public function __construct()
    {
        try{
            ...
            $this->pdo = new PDO("mysql:host=localhost;dbname=".$config['database']['db_name'] , $config['database']['db_user'] , $config['database']['db_password']);
    ...
    {
        return $this->select()->where('id' , $value)->first();
    }
